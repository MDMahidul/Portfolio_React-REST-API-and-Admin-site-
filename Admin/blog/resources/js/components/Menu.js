...
import {faBars, faHome,faEnvelope,faCode,faFolder,faComment,faBookOpen,faPowerOff} from "@fortawesome/free-solid-svg-icons";
        ...
        return (
            <Fragment>
                ...
                <div className={this.state.sideNavClass}>
                    ...
                    <a className=" ml-3 NavItem" href="/onLogout"> <FontAwesomeIcon icon={faPowerOff} /> <span className={this.state.NavText}>Sign Out</span></a>
                </div>
